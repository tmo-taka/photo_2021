...
const workList = css(
    {
        m: '0 auto 8em', w: '90vw',
        md: { m: '0 auto 6em', w: 'contPC',},
        _last: { mb: 0 },
    }
)

const workImage = {
    m: '0 auto', w: '20em', h: '12em', pos: 'relative',
    md: {mr: '48px', w: '400px', h: '200px', borderRadius: 'xl', overflow: 'hidden'}
}

const siteTitle = css(
    {
        pos: 'absolute', bottom: '-1em', right: '-.5em', display: 'inlineBlock', p: '.2em', bg: 'white', borderWidth: '1px', borderColor: '#000',
        md: {w: 'calc(100% - (400px + 48px))', fontSize: '2.4rem', textAlign: 'center', pos: 'relative', p: '0', bottom: '0', right: '0', bg: 'transparent', border: 'none'}
    }
)
